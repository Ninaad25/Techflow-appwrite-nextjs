...
// LabelInputContainer component for styling form inputs with a background and meteors
...
// Type definition for a question with additional content properties
type QuestionWithContent = Models.Document & { content?: string; title?: string; tags?: string[]; attachmentId?: string };

// QuestionForm component for creating or updating questions
const QuestionForm = ({ question }: { question?: QuestionWithContent }) => {
  ...
  const loadConfetti = (timeInMS = 3000) => {
    ...
    const confetti = require("canvas-confetti"); // or import confetti from "canvas-confetti";
    const frame = () => {
